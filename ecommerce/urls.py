...
urlpatterns = [
    ...
    path('admin-add-product/', views.admin_add_product_view, name='admin-add-product'),  # URL for adding a product
    ...
    path('admin-add-product/admin-products/', views.redirect_to_admin_dashboard, name='redirect-to-admin-dashboard'),
]
